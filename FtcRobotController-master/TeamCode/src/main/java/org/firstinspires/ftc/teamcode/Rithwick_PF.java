...
public class Rithwick_PF extends LinearOpMode
{ // Define motors
    DcMotor LV;
    DcMotor RV;
    DcMotor LH;
    ...
    public void DriveFB2(double power, int distance)
    {   //Reset Encoders
    ...
    public void DriveSTS2(double power, int distance)
    {   //Reset Encoders
    ...
    public void DriveSLR(double power, int distance)
    {   //Reset Encoders
        LV.setMode(DcMotor.RunMode.STOP_AND_RESET_ENCODER);
        RV.setMode(DcMotor.RunMode.STOP_AND_RESET_ENCODER);
        LH.setMode(DcMotor.RunMode.STOP_AND_RESET_ENCODER);
