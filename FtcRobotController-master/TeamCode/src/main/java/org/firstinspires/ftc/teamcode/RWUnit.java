...
@Autonomous(name = "Red Warehouse Unit")

public class RWUnit extends LinearOpMode {
    ...
    public void objectRight()
    {
        ...
        Trajectory park = enigma.trajectoryBuilder(new Pose2d(0, 0, 0))
                .strafeRight(60)
                .build();
        enigma.followTrajectory(park);
