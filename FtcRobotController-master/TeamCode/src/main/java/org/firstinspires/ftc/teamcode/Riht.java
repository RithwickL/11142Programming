...
public class Riht extends LinearOpMode {    //Declare motors
    DcMotor Fvertical;
    DcMotor Fhorizontal;
    DcMotor Bvertical;
    DcMotor Bhorizontal;
    ...
    public void runOpMode() { //code will run once only
        ...
        Top = hardwareMap.dcMotor.get("rr");
    ...
    public void DriveSide (double power, int distance){
        ...
        public void Spin (double not, int dis)
        {
            //reset
            Fvertical.setMode(RunMode.STOP_AND_RESET_ENCODER);
            Bvertical.setMode(RunMode.STOP_AND_RESET_ENCODER);
            ...
            //target position
            Fvertical.setTargetPosition(dis*31);
            Bvertical.setTargetPosition(dis*31);
